...
var _appJs = require("./classes/app.js");
var _minCss = require("./styles/min.css");
// import {templates} from'./templated.js'
// import {Site} from './classes/site.js'
// import{Sidebar} from './classes/sidebar.js'
new (0, _appJs.App)((0, _modelJs.model)).init() // const $site = document.querySelector("#site");
 // model.forEach(block => {
...
},{"./model.js":"dEDha","./styles/min.css":"SQxw2","./classes/app.js":"g9LQJ"}],"dEDha":[function(require,module,exports) {
...
var _blockJs = require("./classes/block.js");
...
const model = [
    new (0, _blockJs.TitleBlock)("creating your site use only JavaScript", {
        tag: "h2",
        styles: {
    ...
    new (0, _blockJs.ImageBlock)((0, _imagePngDefault.default), {
        styles: {
            padding: "2rem 0",
            display: "flex",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./assets/image.png":"ljha9","./classes/block.js":"3AZe8"}],"gkKU3":[function(require,module,exports) {
...
module.exports = require("6e524cdf6ee197d3").getBundleURL("bLxZJ") + "image.513edb25.png" + "?" + Date.now();

},{"6e524cdf6ee197d3":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
class TitleBlock extends Block {
    toHtml() {
        ...
        return (0, _utilsJs.row)((0, _utilsJs.col)(`<${tag}>${this.value}</${tag}>`), (0, _utilsJs.css)(styles));
    }
}
class ImageBlock extends Block {
    toHtml() {
        const { imageStyles , alt ="" , styles  } = this.options;
        return (0, _utilsJs.row)(`<img src="${this.value}" style="${(0, _utilsJs.css)(imageStyles)}"/>`, (0, _utilsJs.css)(styles));
    }
}
class ColumnsBlock extends Block {
    toHtml() {
        const html = this.value.map((0, _utilsJs.col)).join("");
        return (0, _utilsJs.row)(html, (0, _utilsJs.css)(this.options.styles));
    }
}
class TextBlock extends Block {
    toHtml() {
        return (0, _utilsJs.row)((0, _utilsJs.col)(`<p>"${this.value}"</p>`, (0, _utilsJs.css)(this.options.styles)));
    }
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"SQxw2":[function() {},{}],"g9LQJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class App {
    ...
    init() {
        ...
        new (0, _sidebarJs.Sidebar)("#panel", updateCallBack);
    }
}

},{"./site.js":"24VTm","./sidebar.js":"5YCBk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"24VTm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Sidebar {
    ...
    add(event) {
        ...
        const newBlock = type === "text" ? (0, _block.TextBlock)(value, {
            styles
        }) : (0, _block.TitleBlock)(value, {
            styles
        });
...
},{"../utils":"en4he","./block":"3AZe8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire2f7f")
